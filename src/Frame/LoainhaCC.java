...
//        if (DialogHelper.confirm(this, "Bạn thực sự muốn xóa ?")) {
    ...
    public JTextField getTxtMaLoaiNhaCC() {
        return txtMaLoaiNhaCC;
    }

    public void setTxtMaLoaiNhaCC(String txtMaLoaiNhaCC) {
        this.txtMaLoaiNhaCC.setText(txtMaLoaiNhaCC);
    }

    public JTextField getTxtQuocGia() {
        return txtQuocGia;
    }
    ...
    public void doClickUpdate() {
        ...
        this.btnSuaActionPerformed(null);
    ...
    public void doClickFirst() {
        LoainhaCC chon = new LoainhaCC();
        String m = chon.getTblBang().getModel().getValueAt(4, 0).toString();
        this.txtMaLoaiNhaCC.setText(m);
        this.btn1ActionPerformed(null);
    ...
    public void doClickPre() {
        ...
        String m = chon.getTblBang().getModel().getValueAt(4, 0).toString();
        this.txtMaLoaiNhaCC.setText(m);
        this.btn4ActionPerformed(null);
    }

    public void doClickNext() {
        this.tblBangMouseClicked(null);
        this.btn2ActionPerformed(null);
    }

    public void doClickLast() {
        this.tblBangMouseClicked(null);
        this.btn3ActionPerformed(null);
    }
...
//        }
        LoainhaCC chon = new LoainhaCC();
        String m = chon.getTblBang().getModel().getValueAt(0, 0).toString();
        this.txtMaLoaiNhaCC.setText(m);
