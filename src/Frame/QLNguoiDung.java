...
//        model.setMaNhom((String) cboND.getSelectedItem());
    ...
    public boolean isvalid() {
        ...
        if (txtMaND.getText().equals("")) {
            DialogHelper.alert(this, "Bạn chưa nhập tên đăng nhập!!");
            ...
            return false;
        } else if (txtMaND.getText().matches(pat)) {
            DialogHelper.alert(this, "Bạn phải nhập theo cú pháp NDxxxx(x phải là số)!!");
            txtMaND.requestFocus();
            return false;
        } else if (txtPass.getText().length() < 5) {
            DialogHelper.alert(this, "Mật khẩu phải có 6 ký tự!!");
            txtPass.requestFocus();
            return false;
        } else if (txtPass.getText().length() > 7) {
            DialogHelper.alert(this, "Mật khẩu phải đúng 6 ký tự!!");
            txtPass.requestFocus();
            return false;
        } else if (!txtPass.getText().matches("[0-9]+")) {
            DialogHelper.alert(this, "Mật khẩu chỉ số");
            txtPass.requestFocus();
            return false;
            ...
            return false;
        } else if (!txtTenND.getText().matches("[a-z A-z]+")) {
            DialogHelper.alert(this, "Tên bạn nhập có số hoặc kí tự đặc biệt!!");
            txtTenND.requestFocus();
            return false;
        } else if (model != null) {
    ...
    void insert() {
        ...
        String confirm = new String(txtXNpass.getPassword());
...
//                e.printStackTrace();
    ...
    public void setTxtMaND(String mnd) {
        this.txtMaND.setText(mnd);
    }

    public void setTxtTenND(String tnd) {
        this.txtTenND.setText(tnd);
    }

    public void setTxtPass(String pw) {
        this.txtPass.setText(pw);
    }

    public void setTxtXNpass(String xn) {
        this.txtXNpass.setText(xn);
    }
    ...
    private void initComponents() {
        ...
        cboND.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboNDActionPerformed(evt);
            }
        });
        ...
        tblND.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tên tài khoảng", "Họ và Tên", "Mật khẩu", "Vai trò"
            }
        ) {
    ...
    private void cboNDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboNDActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cboNDActionPerformed
