...
//this.setStatus(true);
    ...
    public JComboBox<String> getJcbML() {
        return jcbML;
    }

    public void setJcbML(JComboBox<String> jcbML) {
        this.jcbML = jcbML;
    }

    public JComboBox<String> getJcbMNCC() {
        return jcbMNCC;
    }

    public void setJcbMNCC(JComboBox<String> jcbMNCC) {
        this.jcbMNCC = jcbMNCC;
    }

    public JComboBox<String> getJcbMaNhap() {
        return jcbMaNhap;
    }

    public void setJcbMaNhap(JComboBox<String> jcbMaNhap) {
        this.jcbMaNhap = jcbMaNhap;
    }

    public JTextField getTxtHSD() {
        return txtHSD;
    }

    public void setTxtHSD(String txtHSD) {
        this.txtHSD.setText(txtHSD);
;    }

    public JTextField getTxtMSP() {
        return txtMSP;
    }

    public void setTxtMSP(String txtMSP) {
        this.txtMSP.setText(txtMSP);
    }

    public JTextField getTxtNSX() {
        return txtNSX;
    }

    public void setTxtNSX(String txtNSX) {
        this.txtNSX.setText(txtNSX);
    }

    public JTextField getTxtTSP() {
        return txtTSP;
    }

    public void setTxtTSP(String txtTSP) {
        this.txtTSP.setText(txtTSP);
    }
    ...
    public void dolickUpdate(){
        this.btnUpdateActionPerformed(null);
    }
    public void dolickDe(){
        this.btnDeleteActionPerformed(null);
    }
    public void dolickcClear(){
...
//DialogHelper.alert(this, "Chưa chọn mã kho");
            ...
            this.test=false;// DialogHelper.alert(this, "Chưa chọn mã kho");
return false;
        }
//        else if (!txtNSX.getText().matches("\\d{1,2}[-|/]\\d{1,2}[-|/]\\d{4}")) {
//            DialogHelper.alert(this, "Sai định dạng ngày");
...
this.test=false;//DialogHelper.alert(this, "Thêm mới thành công!");
        } catch (Exception e) {
          this.test=false; // DialogHelper.alert(this, "Thêm mới thất bại!" + e);
        }
    ...
    void update() {
        ...
        try {
            dao.update(model);
            this.load();
         this.test=false;  // DialogHelper.alert(this, "Cập nhật thành công!");
        } catch (Exception e) {
           this.test=false; //DialogHelper.alert(this, "Cập nhật thất bại!" + e);
        }
    }
    ...
    void delete() {
        if (DialogHelper.confirm(this, "Bạn thực sự muốn xóa người học này?")) {
            ...
            try {
                ...
                this.load();
                this.clear();
              this.test=true;//  DialogHelper.alert(this, "Xóa thành công!");
            } catch (HeadlessException e) {
              this.test=false; // DialogHelper.alert(this, "Xóa thất bại!");
            }
        }
    }
    ...
    void edit() {
        try {
            ...
            this.test=false;//DialogHelper.alert(this, "Lỗi truy vấn dữ liệu!" + e);
...
//    } 
    void fillComboBox() {
        ...
        try {
         ...
         this.test=false; //  DialogHelper.alert(this, "Lỗi truy vấn dữ liệu!");
        }
    }
...
//    }
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
         ...
         try {
           ...
           this.test=false;//DialogHelper.alert(this, "Định dạng ngày không đúng theo dd/MM/yyyy");
